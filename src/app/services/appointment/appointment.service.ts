...
export class AppointmentService {
  ...
  getAppointmentsForSpecificField(getAppointmentsForSpecificFieldRequest: GetAppointmentsForSpecificFieldRequest): Observable<Array<Appointment>> {
    return this.http.post<Array<Appointment>>(this.url + 'get-appointments-for-specific-field', getAppointmentsForSpecificFieldRequest);
  }
}
