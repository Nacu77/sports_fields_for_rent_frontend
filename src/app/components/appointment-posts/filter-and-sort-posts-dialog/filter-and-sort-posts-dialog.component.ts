...
@Component({
  ...
  templateUrl: './filter-and-sort-posts-dialog.component.html',
  styleUrls: ['./filter-and-sort-posts-dialog.component.css'],
})
export class FilterAndSortPostsDialogComponent {
  invalidMessage: string | undefined = undefined;

  sortAsc: boolean = true;

  constructor(public dialogRef: MatDialogRef<FilterAndSortPostsDialogComponent>, @Inject(MAT_DIALOG_DATA) public data: any) {}
