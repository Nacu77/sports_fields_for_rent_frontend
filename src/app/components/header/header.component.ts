...
export class HeaderComponent {
  ...
  getHeaderDetails(): HeaderDetails | null {
    switch (this.url) {
      ...
      case '/home':
        return {
          backgroundImage: '../../../../assets/images/header_football_image.jpg',
          title: 'Sport for all',
      ...
      case '/sport-fields':
        return {
          backgroundImage: '../../../../assets/images/header_basketball_image.jpg',
      ...
      case '/appointment-posts':
        return {
          backgroundImage: '../../../../assets/images/header_tennis_image.jpg',
